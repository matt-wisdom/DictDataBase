...
def db_paths(db_name: str) -> Tuple[str, bool, str, bool]:
	...
	1: json_path: path to the json file,
	2: json_exists: True if the json file exists,
	3: ddb_path: path to the ddb file,
	4: ddb_exists: True if the ddb file exists.
